...
const Hero = () => {
  return (
    <section className="relative w-full h-[36rem] md:h-screen mx-auto">
      <div
      ...
      >
        ...
        <div className="mt-20">
          <h1 className={`${styles.heroHeadText} text-white`}>
            Hi there 👋 I&apos;m <span className="text-[#915eff]">John</span>
          </h1>
      ...
      {/* <ComputersCanvas/> */}
      <div className="absolute xs:bottom-10 bottom-32 w-full flex justify-center items-center border">
        <a href="#about">
